...
use PalufAdminBundle\Form\PageType;
...
class PageController extends Controller
{
    ...
    {
        $page = new Page();
        $form = $this->createForm("PalufAdminBundle\\Form\\PageType", $page);
        ...
        return $this->render('PalufAdminBundle:Page:new.html.twig', array(
            'page' => $page,
    ...
    public function showAction(Page $page)
    {
        ...
        return $this->render('PalufAdminBundle:Page:show.html.twig', array(
            'page' => $page,
    ...
    {
        $deleteForm = $this->createDeleteForm($page);
        $editForm = $this->createForm("PalufAdminBundle\\Form\\PageType", $page);
        ...
        return $this->render('PalufAdminBundle:Page:edit.html.twig', array(
            'page' => $page,
